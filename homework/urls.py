...
homework_router = nested_routers.NestedSimpleRouter(study_router, r'study', lookup='study')
homework_router.register(r'homework', HomeWorkViewSet, base_name='study-homework')
