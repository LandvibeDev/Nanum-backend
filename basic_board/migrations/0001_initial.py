    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, help_text='작성일')),
                ('update_date', models.DateTimeField(auto_now=True, help_text='수정일')),
                ('basic_board', models.ForeignKey(blank=True, help_text='게시글', null=True, on_delete=django.db.models.deletion.CASCADE, to='basic_board.BasicBoard')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateTimeField(auto_now=True, help_text='수정일')),
                ('attached_file', models.FileField(blank=True, help_text='게시글 첨부파일', null=True, upload_to=basic_board.models.get_basic_board_file_path)),
                ('basic_board', models.ForeignKey(blank=True, help_text='게시글', null=True, on_delete=django.db.models.deletion.CASCADE, to='basic_board.BasicBoard')),
            ],
            options={
                'ordering': ('-pk', 'create_date'),
